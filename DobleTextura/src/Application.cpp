...
GLuint Application::initTexture(const std::string name)//FUNCION PARA DOBLE TEXTURA
{
...
void Application::setup()
{
	...
	oPlane.texture_id[0] = initTexture("sw.png");
	oPlane.texture_id[1] = initTexture("gta.png");
...
void Application::display()
{
	...
	glBindTexture(GL_TEXTURE_2D, oPlane.texture_id[0]);//TEXTURA 1
	glUniform1i(oPlane.uTexture[0], 0);
	glActiveTexture(GL_TEXTURE0);

	glBindTexture(GL_TEXTURE_2D, oPlane.texture_id[1]);//TEXTURA 2
