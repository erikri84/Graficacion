...
void Application::setup()
{
	...
	oPlane.texture_id[0] = initTexture("map1.png");
	oPlane.texture_id[1] = initTexture("map0.png");
...
void Application::display()
{
	...
	glBindTexture(GL_TEXTURE_2D, oPlane.texture_id[0]);//TEXTURA BLANCO Y NEGRO
	glUniform1i(oPlane.uTexture[0], 0);
	glActiveTexture(GL_TEXTURE0);

	glBindTexture(GL_TEXTURE_2D, oPlane.texture_id[1]);//TEXTURA DE COLOR
